    ...
    return (
        <div className="stacked-option-premium-container" style={{overflow:"hidden"}}>
            ...
            <Row className="option-premium-label-container mt-2">
                <Col className="md-4 premium-label"><div className="premium-square" style={{background:"black"}}></div>&nbsp;SL Points: {SLAmountInOptionPremium}</Col>
                <Col className="md-4 premium-label"><div className="premium-square" style={{background:"black"}}></div>&nbsp;Premium Price: {EntryAmountInOptionPremium}</Col>
                <Col className="md-4 premium-label"><div className="premium-square" style={{background:"black"}}></div>&nbsp;Target Points: {TargetAmountInOptionPremium}</Col>
            </Row>
            </>
            }
