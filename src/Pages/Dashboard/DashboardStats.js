            ...
            <CardBody>
              <div className="d-flex text-muted">
                ...
                <div className="flex-grow-1 overflow-hidden">
                  <p className="mb-1">Total Stocks Available</p>
          ...
          <Card>
            <CardBody>
              <div className="d-flex">
                ...
                <div className="flex-grow-1 overflow-hidden">
                  <p className="mb-1">Total Dataset Count</p>
          ...
          <Card>
            <CardBody>
              <div className="d-flex">
                ...
                <div className="flex-grow-1 overflow-hidden">
                  <p className="mb-1">Dataset Date Range</p>
                  <span className="mb-3">24.03 % to</span> <br />
                  <span className="mb-3">24.03 %</span>
                  {/* <p className="text-truncate mb-0">
