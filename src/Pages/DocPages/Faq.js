...
function Faq() {
    ...
    const t_col3 = () => { disableAllCols(); setcol3(!col3); };
    const t_col4 = () => { disableAllCols(); setcol4(!col4); };
    const t_col5 = () => { disableAllCols(); setcol5(!col5); };
    const t_col6 = () => { disableAllCols(); setcol6(!col6); };
                        ...
                        <Row>
                            <Col xl={12}>
                                <div className="doc-card">
                                    <h2 className="doc-main-heading">Frequently Asked Questions</h2>
                                    ...
                                    <div className="faq-accordion accordion accordion-flush" id="accordionFlushExample">
                                        ...
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingFlushThree">
                                                <button
                                                    ...
                                                    style={{ cursor: "pointer" }}
                                                >
                                                    What Types of Risks Can I Manage with Trrader.in Tool suite?
                                                </button>
                                            </h2>
                                        ...
                                        {/* FAQ Item 4 */}
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingFlushFour">
                                                <button
                                                    className={classnames("accordion-button", "fw-medium", { collapsed: !col4 })}
                                                    type="button"
                                                    onClick={t_col4}
                                                    style={{ cursor: "pointer" }}
                                                >
                                                    Is Trrader.in Tool suitable for retail traders and beginners?
                                                </button>
                                            </h2>
                                        ...
                                        {/* FAQ Item 5 */}
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingFlushFive">
                                                <button
                                                    className={classnames("accordion-button", "fw-medium", { collapsed: !col5 })}
                                                    type="button"
                                                    onClick={t_col5}
                                                    style={{ cursor: "pointer" }}
                                                >
                                        ...
                                        {/* FAQ Item 6 */}
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingFlushSix">
                                                <button
                                                    className={classnames("accordion-button", "fw-medium", { collapsed: !col6 })}
                                                    type="button"
                                                    onClick={t_col6}
                                                    style={{ cursor: "pointer" }}
                                                >
                                        ...
                                        {/* FAQ Item 7 */}
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingFlushSeven">
                                                <button
                                                    className={classnames("accordion-button", "fw-medium", { collapsed: !col7 })}
                                                    type="button"
                                                    onClick={t_col7}
                                                    style={{ cursor: "pointer" }}
                                                >
                                        ...
                                        {/* FAQ Item 8 */}
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingFlushEight">
                                                <button
                                                    className={classnames("accordion-button", "fw-medium", { collapsed: !col8 })}
                                                    type="button"
                                                    onClick={t_col8}
                                                    style={{ cursor: "pointer" }}
                                                >
                                                    Is Training Available for Trrader.in Tool?
                                                </button>
                                            </h2>
                                        ...
                                        {/* FAQ Item 9 */}
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingFlushNine">
                                                <button
                                                    ...
                                                    style={{ cursor: "pointer" }}
                                                >
                                                    How Do I Contact Trrader.in Support?
                                                </button>
                                            </h2>
